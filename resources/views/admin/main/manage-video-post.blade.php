                ...
                <div class="col-12">
                    <div class="padding-12">
                        <div class="label-container mb-2">
                            <h5>Tất cả bài viết video: {{ $validPosts }}/{{ count($posts) }} bài viết</h5>
                        </div>
                        <form class="d-flex justify-content-between">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label style="user-select: none;" for="hideDeletedPost" class="form-check-label">
                                        Ẩn bài viết đã xoá</label>
                                </div>
                            </div>
                        </form>
                        <table class="table">
                                        ...
                                        <tr class="post-row @php echo ($post->deleted_at) ? 'hidden' : 'visible'  @endphp">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    <a href="{{ route('post.editVideoPostForm', ['post' => $post->id]) }}"
