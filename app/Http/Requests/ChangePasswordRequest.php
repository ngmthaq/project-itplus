...
class ChangePasswordRequest extends FormRequest
{
    ...
    {
        return [
            'old_password' => ['required', new RequiresAtLeast8CharactersAndContainAtLeast1LetterAnd1Number()],
    ...
    {
        return [
            'old_password.required' => 'Mật khẩu có ít nhất 8 kí tự, có tối thiểu 1 chữ và 1 số',
